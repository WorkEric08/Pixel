  ...
  return (
    ...
    >
      <div 
        ...
        className="bg-slate-900 w-full max-w-2xl rounded-2xl p-5 md:p-6 border border-slate-700 shadow-2xl flex flex-col gap-3 animate-in zoom-in-95 duration-300 overflow-hidden relative cursor-default"
      >
        ...
        {!isFirstRun && (
          <button 
            onClick={onClose} 
            className="absolute top-4 right-4 p-2 bg-slate-800/50 hover:bg-slate-700 text-slate-400 hover:text-white rounded-xl transition-all border border-slate-700/50 z-20 group active:scale-90"
            aria-label="Fechar"
          >
            ...
            <div className="space-y-2">
              <div className="flex flex-col gap-1">
                ...
                <button 
                  ...
                  className={`w-full p-3.5 rounded-xl border flex items-center justify-between transition-all text-sm
                    ${activePicker === 'start' ? 'border-emerald-500 bg-emerald-500/5 shadow-[0_0_15px_rgba(16,185,129,0.1)]' : 'border-slate-800 bg-slate-950/50 hover:border-slate-700'}
              ...
              <div className="flex flex-col gap-1">
                ...
                <button 
                  ...
                  className={`w-full p-3.5 rounded-xl border flex items-center justify-between transition-all text-sm
                    ${activePicker === 'target' ? 'border-emerald-500 bg-emerald-500/5 shadow-[0_0_15px_rgba(16,185,129,0.1)]' : 'border-slate-800 bg-slate-950/50 hover:border-slate-700'}
                  `}
                >
          ...
          <div className="flex flex-col gap-3">
            <div className={`transition-all duration-500`}>
              {activePicker ? (
                ...
                <div className="h-[280px] flex flex-col items-center justify-center text-center p-6 bg-slate-950/30 rounded-2xl border border-dashed border-slate-700">
            ...
            <div className="flex gap-3">
              {!isFirstRun && (
                <button 
                  onClick={onClose}
                  className="flex-1 p-3.5 rounded-xl bg-slate-800 text-slate-400 font-black hover:bg-slate-700 transition-all uppercase tracking-[0.2em] text-[10px] active:scale-95 border border-slate-700"
                >
                  Cancelar
                </button>
              )}
